...
class ElipticDSA:
    ...
    def __init__(self, privateKey=None,publicKey=None,hashFunc=sha256) -> None:
        if(not privateKey):
    ...
    def sign(self,msg):
        return Ecdsa.sign(msg,self.private, hashfunc=self.hash)
    
    def verify(self, msg, signature):
        return Ecdsa.verify(msg, signature, self.public, self.hash)
